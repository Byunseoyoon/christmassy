...
<body>
	...
	<div class="content">
        제1조(목적)<br>
        이 약관은 컴퓨터몰 회사(전자상거래 사업자)가 운영하는 컴퓨터몰 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.<br>
        ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다<br>
        제2조(정의)<br>
		①“몰”이란 컴퓨터몰 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br>
		...
		①“몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 모사전송번호, 전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 컴퓨터몰 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br>
		...
		⑤ 회원가입은 반드시 실명으로만 가입할 수 있으며 몰은 실명확인조치를 할 수 있습니다.<br>
		⑥ 타인의 명의(이름 및 주민등록번호 등)를 도용하여 이용신청을 한 회원의 모든 ID는 삭제되며, 관계법령에 따라 처벌을 받을 수 있습니다.<br>
		제7조(회원 탈퇴 및 자격 상실 등)<br>
		① 회원은“몰”에 언제든지 자유롭게 탈퇴할 수 있으며, 회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 몰의 웹사이트에서 회원탈퇴 메뉴를 이용해 가입해지를 하여야 합니다.<br>
		...
		6. 결제방법의 선택<br>
		② 단, 1조2항의 경우 회원로그인으로 대신할 수 있습니다.<br>
		제10조 (이용신청의 승낙과 제한)<br>
		① 몰은 아래사항에 해당하는 경우에 대해서 승낙하지 아니 합니다.<br>
		1. 실명이 아니거나 타인의 명의를 이용하여 신청한 경우<br>
		2. 사회의 안녕과 질서, 미풍양속을 저해할 목적으로 신청한 경우<br>
		3. 부정한 용도로 본 서비스를 이용하고자 하는 경우<br>
		4. 기타 규정한 제반사항을 위반하며 신청하는 경우<br>
		② 몰은 서비스 이용신청이 다음 각 호에 해당하는 경우에는 그 신청에 대하여 승낙 제한사유가 해소될 때까지 승낙을 유보할 수 있습니다.<br>
		1. 몰의 기술상 지장이 있는 경우<br>
		2. 기타 몰의 귀책사유로 이용승낙이 곤란한 경우<br>
		③ 몰은 이용신청고객이 관계법령에서 규정하는 미성년자일 경우에 승낙을 보류할 수 있습니다. 또한 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자 본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지합니다<br>
		...
		② 단, 무통장입금으로 결제한 경우에는 입금확인일까지는 배송기간에서 제외됩니다.<br>
		...
		2. 회원 관리, 시스템 관리, 정보의 제공 등을 위하여 몰이 호스팅을 받는 업체에 제공하는 경우<br>
		3. 통계작성, 학술연구 또는 시장조사를 위하여 필요한 경우로서 특정 개인을 식별할 수 없는 형태로 제공하는 경우<br>
		4. 재화등의 거래에 따른 대금정산을 위하여 필요한 경우<br>
		5. 도용방지를 위하여 본인확인에 필요한 경우<br>
		...
		1. 회원가입정보의 경우: 회원퇄퇴를 하거나 회원에서 제명된 때<br>
		2. 대금지금정보의 경우: 대금의 완제일 또는 채권소멸시효기간이 만료된 때<br>
		3. 배송정보의 경우: 물품 또는 서비스가 인도되거나 제공된 때<br>
		4. 설문조사, 이벤트 등의 목적을 위하여 수집한 경우: 당해 설문조사, 이벤트 등이 종료한 때<br>
		다만, 수집목적 또는 제공받은 목적이 달성된 경우에도 상법 등 관계 법령의 규정에 의하여 보존할 필요성이 있는 경우에는 귀하의 개인정보를 보유할 수 있습니다.<br>
		1. 계약 또는 청약철회 등에 관한 기록 : 5년<br>
		2. 대금결제 및 재화등의 공급에 관한 기록 : 5년<br>
		3. 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년<br>
		제18조(“몰”의 의무)<br>
		① 몰은 계속적이고 안정적인 서비스의 제공을 위하여 설비에 장애가 생기거나 멸실된 때에는 부득이한 사유가 없는 한 지체 없이 이를 수리 또는 복구합니다.<br>
		②“몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화, 용역을 제공하는데 최선을 다하여야 합니다.<br>
		③“몰”은 개인정보 보호를 위해 보안시스템을 구축하며 개인정보 보호정책을 공시하고 준수합니다.<br>
		...
		⑤“몰”은 회원으로부터 제기되는 의견이나 불만이 정당하다고 객관적으로 인정될 경우에는 적절한 절차를 거쳐 즉시 처리하여야 합니다. 다만, 즉시 처리가 곤란한 경우는 회원에게 그 사유와 처리일정을 통보하여야 합니다.<br>
		...
		① 상위“몰”과 하위“몰”이 하이퍼 링크(예 : 하이퍼 링크의 대상에는 문자, 그림 및 동화상 등이 포함됨)방식 등으로 연결된 경우, 전자를 연결“몰”(웹사이트)이라고 하고 후자를 피연결“몰”(웹사이트) 이라고 합니다.<br>
		...
		제 24 조 (면책조항)<br>
		①“몰”은 천재지변, 전쟁 및 기타 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스 제공에 대한 책임이 면제됩니다.<br>
		②“몰”은 기간통신 사업자가 전기통신 서비스를 중지하거나 정상적으로 제공하지 아니하여 손해가 발생한 경우 책임이 면제됩니다.<br>
		③“몰”은 서비스용 설비의 보수, 교체, 정기점검, 공사 등 부득이한 사유로 발생한 손해에 대한 책임이 면제됩니다.<br>
		④“몰”은 이용자의 귀책사유로 인한 서비스 이용의 장애 또는 손해에 대하여 책임을 지지 않습니다.<br>
		⑤“몰”은 이용자의 컴퓨터 오류에 의해 손해가 발생한 경우, 또는 회원이 신상정보 및 전자우편 주소를 부실하게 기재하여 손해가 발생한 경우 책임을 지지 않습니다.<br>
		⑥“몰”은 이용자가 서비스를 이용하여 기대하는 수익을 얻지 못하거나 상실한 것에 대하여 책임을 지지 않습니다.<br>
		⑦“몰”은 이용자가 서비스를 이용하면서 얻은 자료로 인한 손해에 대하여 책임을 지지 않습니다. 또한 몰은 이용자가 서비스를 이용하며 타 이용자로 인해 입게 되는 정신적 피해에 대하여 보상할 책임을 지지 않습니다.<br>
		⑧“몰”은 이용자 상호간 및 이용자와 제3자 상호 간에 서비스를 매개로 발생한 분쟁에 대해 개입할 의무가 없으며, 이로 인한 손해를 배상할 책임도 없습니다.<br>
		제24조(재판권 및 준거법)<br>
		① 이 약관에 명시되지 않은 사항은 전기통신사업법 등 관계법령과 상관습에 따릅니다.<br>
		② 회사의 정액 서비스 회원 및 기타 유료 서비스 이용 회원의 경우 회사가 별도로 정한 약관 및 정책에 따릅니다.<br>
		③ 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 몰의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.<br>
